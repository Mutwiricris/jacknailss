...
CREATE TABLE `bookings` (
  ...
  `payment_method` enum('mpesa','cash','card') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `bookings_appointment_date_status_index` (`appointment_date`,`status`),
  KEY `bookings_client_email_appointment_date_index` (`client_email`,`appointment_date`),
...
CREATE TABLE `payments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `booking_id` bigint unsigned NOT NULL,
  `payment_reference` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` decimal(8,2) NOT NULL,
  `method` enum('mpesa','cash','card') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mpesa',
  ...
  KEY `payments_status_method_index` (`status`,`method`),
  KEY `payments_mpesa_transaction_id_index` (`mpesa_transaction_id`),
...
CREATE TABLE `services` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `services_status_is_popular_index` (`status`,`is_popular`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_09_17_164621_create_services_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_09_17_164627_create_bookings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_09_17_164637_create_booking_services_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_09_17_164648_create_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2025_09_17_164702_create_time_slots_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2025_09_20_083243_add_image_to_services_table',2);
